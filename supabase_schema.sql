...
INSERT INTO public.public_projects (id, name, status, status_bg, location, type, image, description, price, area, map_link, nearby_hospitals, nearby_schools, nearby_colleges, nearby_markets) VALUES
    ...
    ('p2', 'Green Valley Residency', 'READY TO MOVE', '#0a3d2e', 'BB Road, Narayanganj', 'Residential', '/Frontend/Projects/The_Heritage_Plaza.svg', 'Eco-friendly luxury residential gated community featuring lush green balconies, solar power integration, and riverfront peaceful surroundings.', 'Starting from ৳1.10Cr', '1,200 - 2,200 sqft', 'https://maps.google.com/maps?q=23.6238,90.4993&z=15&output=embed', 'Narayanganj 200 Bed Hospital (0.8 km), Popular Diagnostic (1.2 km)', 'Ideal School & College (0.6 km), Narayanganj Govt High School (1.1 km)', 'Tolaram Govt College (1.3 km)', 'Shamabay New Market (0.3 km), Balur Math Market (0.7 km)')
